...
from scrapper_app.views import SelectProductView, ProductView, DownloadView, AddProductView, SelectOpinionView, OpinionView, HomeView, AboutView
...
urlpatterns = [
    ...
    re_path(r'^products\/(?P<product_id>\d+)\/download\/$', DownloadView.as_view(), name='download'),
